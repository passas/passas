  ...
  <br>
    <ol>
      ...
      <br>
        <ol>
          <!--1.2.a-->
          <li>I may have you blocked in another social media platform. This is due two main reasons: (1) I don't like you, and (2) you lack of personality from the moment where you intended to cross my path. Or something else.</li>
          <br>
        </ol>
    </ol>
